...
than the allowed minimum charge, $m\kappa_{b_i}$. This is further discussed in [[#sec:constraints]]. Note that the variables
...
bibliography:~/Documents/literature/ref.bib
