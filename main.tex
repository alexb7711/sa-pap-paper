...
\caption{Perturb schedule algorithm} \label{alg:perturb-schedule}
    ...
    \Begin
    {
        ...
        $y_v \leftarrow [1.0; n_V]$\tcc*{Create weight vector for index selection}
        ...
        \ForEach{$\I_i \leftarrow \I_{|\I|} \text{ TO } \I_{1}$}
        {
            ...
            \If{$p_{\I_{i.b}} = true$}{$y_v_{\I_i} = y_v_{\I_{i.\xi}}$\;}
            ...
            \ElseIf{$\I_{i.\eta} \le \nu_{\I_{i.b}} \kappa_{\I_{i.b}}$}{
                ...
                $y_v_{\I_i} = \kappa_{\I_{i.b}} + \kappa_{\I_{i.b}} (\nu_{\I_{i.b}}\kappa_{\I_{i.b}} - \I_{i.\eta})$\tcc*{Calculate the weight of the current visit}
            }
        }
        $\I_i\leftarrow\; \W^{y_v}_{\I}$\tcc*{Select an index with a weighted distribution}
