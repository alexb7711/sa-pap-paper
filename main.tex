...
with a weighted distribution \(y\). Thus, \ref{alg:perturb-schedule} is as follows: Line 2 selects a visit at random with
a weighted distribution. Line 3 extracts the visit index. Letting \(n_G\) denote the number of primitive generating
