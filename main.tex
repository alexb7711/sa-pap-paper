...
disjoint (Halmos, Paul R., 1974). The inverse of a disjoint set can be found by the De Morgan Law as shown
...
(Radosavljevic, Jordan, 2018). The method that will be employed to exploit the given solution is as follows:
