...
\subsection{SA PAP Pseudo Code :PROPERTIES: :CUSTOM\textsubscript{ID}: sec:sa-pap-pseudo-code :END: The objective is now to outline SA-PAP in}
\label{sec:org94389a2}
