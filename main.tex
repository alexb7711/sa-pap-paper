...
(De Filippo, Giovanni and Marano, Vincenzo and Sioshansi, Ramteen, 2014, Xylia, Maria and Silveira, Semida, 2018, Guida, U and Abdulah, A, 2017, Li, Jing-Quan, 2016). Particularly,
the electrification of public bus transportation via battery power, i.e., battery electric buses (BEBs), has received
significant attention (Li, Jing-Quan, 2016). Although the technology provides benefits beyond reduction in
emissions, such as lower driving costs, lower maintenance costs, and reduced vehicle noise, battery powered systems
introduce new challenges such as larger upfront costs, and potentially several hours long ``refueling'' periods
(Xylia, Maria and Silveira, Semida, 2018, Li, Jing-Quan, 2016). Furthermore, the problem is exacerbated by the constraints of the
transit schedule to which the fleet must adhere, the limited amount of chargers available, and the adverse affects in
the health of the battery due to fast charging (Lutsey, Nic and Nicholas, Michael, 2019). This work presents a scheduling
...
infrastructure (Wei, Ran and Liu, Xiaoyue and Ou, Yi and Fayyaz, S Kiavash, 2018, Sebastiani, Mariana Teixeira and L{\"u}ders, Ricardo and Fonseca, Keiko VerÃ´nica Ono, 2016, 
Hoke, Anderson and Brissette, Alexander and Smith, Kandler and Pratt, Annabelle and Maksimovic, Dragan, 2014, Wang, Xiumin and Yuen, Chau and Hassan, Naveed Ul and An, Ning and Wu, Weiwei, 2017). Additionally, the prospect of solving both problems simultaneously
has received much attention (Wei, Ran and Liu, Xiaoyue and Ou, Yi and Fayyaz, S Kiavash, 2018, Sebastiani, Mariana Teixeira and L{\"u}ders, Ricardo and Fonseca, Keiko VerÃ´nica Ono, 2016, 
Hoke, Anderson and Brissette, Alexander and Smith, Kandler and Pratt, Annabelle and Maksimovic, Dragan, 2014, Wang, Xiumin and Yuen, Chau and Hassan, Naveed Ul and An, Ning and Wu, Weiwei, 2017). These problems vary by including assignment of buses to routes
(Rinaldi, Marco and Picarelli, Erika and D'Ariano, Andrea and Viti, Francesco, 2020,  Zhou, Guang-Jing and Xie, Dong-Fan and Zhao, Xiao-Mei and Lu, Chaoru, 2020,  Tang, Xindi and Lin, Xi and He, Fang, 2019,  Li, Jing-Quan, 2014), determining
whether a set of existing combustion based buses should be replaced with BEBs (Zhou, Yirong and Liu, Xiaoyue Cathy and Wei, Ran and Golub, Aaron, 2020, 
Duan, Mengyuan and Qi, Geqi and Guan, Wei and Lu, Chaoru and Gong, Congcong, 2021,  Rinaldi, Marco and Picarelli, Erika and D'Ariano, Andrea and Viti, Francesco, 2020,  Zhou, Guang-Jing and Xie, Dong-Fan and Zhao, Xiao-Mei and Lu, Chaoru, 2020), and accounting for uncertainties
(Bie, Yiming and Ji, Jinhua and Wang, Xiangyu and Qu, Xiaobo, 2021,  Duan, Mengyuan and Qi, Geqi and Guan, Wei and Lu, Chaoru and Gong, Congcong, 2021,  Tang, Xindi and Lin, Xi and He, Fang, 2019, Evrim Ursavas and Stuart X. Zhu, 2016). These problems
add additional complexities that warrant simplifications for the sake of computation. Two modes of simplification are
often found: only utilizing fast chargers during planning (Li, Jing-Quan, 2014,  Li, Jing-Quan, 2014, 
Yusheng Wang and Yongxi Huang and Jiuping Xu and Nicole Barclay, 2017) or simplification of the charging models are made by assuming full charge
(Zhou, Yirong and Liu, Xiaoyue Cathy and Wei, Ran and Golub, Aaron, 2020,  Qarebagh, Ahad Javandoust and Sabahi, Farnaz and Nazarpour, Dariush, 2019,  Wei, Ran and Liu, Xiaoyue and Ou, Yi and Fayyaz, S Kiavash, 2018).
...
over-charged, under-charged, or forced to perform ``deep'' deep cycles (Zhou, Yirong and Liu, Xiaoyue Cathy and Wei, Ran and Golub, Aaron, 2020, 
Millner, Alan, 2010,  Edge, Jacqueline S. and O’Kane, Simon and Prosser, Ryan and Kirkaldy, Niall D. and Patel, Anisha N. and Hales, Alastair and Ghosh, Abir and Ai, Weilong and Chen, Jingyi and Yang, Jiang and Li, Shen and Pang, Mei-Chin and Bravo Diaz, Laura and Tomaszewska, Anna and Marzook, M. Waseem and Radhakrishnan, Karthik N. and Wang, Huizhi and Patel, Yatish and Wu, Billy and Offer, Gregory J., 2021). While the charge profile for batteries are inherently non-linear, some
works have assumed a proportional charge increase as linear battery dynamics remain a valid assumption when the battery
SOC is below 80\% (Tao Liu and Avishai {(Avi) Ceder}, 2020). Furthermore, other works have suggested that charging a battery nearly
to capacity is detrimental to the health and can significantly reduce the total charge cycles a battery may undergo
(Edge, Jacqueline S. and O’Kane, Simon and Prosser, Ryan and Kirkaldy, Niall D. and Patel, Anisha N. and Hales, Alastair and Ghosh, Abir and Ai, Weilong and Chen, Jingyi and Yang, Jiang and Li, Shen and Pang, Mei-Chin and Bravo Diaz, Laura and Tomaszewska, Anna and Marzook, M. Waseem and Radhakrishnan, Karthik N. and Wang, Huizhi and Patel, Yatish and Wu, Billy and Offer, Gregory J., 2021,  Millner, Alan, 2010). Thus, this work assumes that a linear model is sufficiently
accurate to produce an operationally valid schedule while maintaining battery health.

Works concerning charge planning often use a version of the vehicle scheduling problem (Tang, Xindi and Lin, Xi and He, Fang, 2019, 
Li, Jing-Quan, 2014,  He, Yi and Liu, Zhaocai and Song, Ziqi, 2020). Variants of this problem address infrastructure as well as determining
existing buses that should be replaced by a BEB (Zhou, Yirong and Liu, Xiaoyue Cathy and Wei, Ran and Golub, Aaron, 2020,  Duan, Mengyuan and Qi, Geqi and Guan, Wei and Lu, Chaoru and Gong, Congcong, 2021, 
Rinaldi, Marco and Picarelli, Erika and D'Ariano, Andrea and Viti, Francesco, 2020,  Zhou, Guang-Jing and Xie, Dong-Fan and Zhao, Xiao-Mei and Lu, Chaoru, 2020). This work bases its implementation on what is known as the Position
allocation problem (Qarebagh, Ahad Javandoust and Sabahi, Farnaz and Nazarpour, Dariush, 2019). The PAP is derived from the Berth Allocation Problem (BAP) which
...
(Pablo Frojan and Juan Francisco Correcher and Ramon Alvarez-Valdes and Gerasimos Koulouris and Jose Manuel Tamarit, 2015,  Qarebagh, Ahad Javandoust and Sabahi, Farnaz and Nazarpour, Dariush, 2019, Zhou, Guang-Jing and Xie, Dong-Fan and Zhao, Xiao-Mei and Lu, Chaoru, 2020). Due to the close relationship
between the BAP and PAP, BAP literature may be used for the PAP. The literature shows methods of handling multiple quays
(sets of chargers) to handle general berthing scenarios (Pablo Frojan and Juan Francisco Correcher and Ramon Alvarez-Valdes and Gerasimos Koulouris and Jose Manuel Tamarit, 2015, Jam Dai and Wuqin Lin and Rajeeva Moorthy and Chung-Piaw Teo, 2008).
Heuristic procedures for quicker solve times have also been introduced (Akio Imai and Etsuko Nishimura and Stratos Papadimitriou, 2001). Methods of
...
(Marilyn Bello and Gonzalo N{\'a}poles and Ivett Fuentes and Isel Grau and Rafael Falcon and Rafael Bello and Koen Vanhoof, 2019, Jam Dai and Wuqin Lin and Rajeeva Moorthy and Chung-Piaw Teo, 2008, Katja Buhrkal and Sara Zuglian and Stefan Ropke and Jesper Larsen and Richard Lusby, 2011, Pablo Frojan and Juan Francisco Correcher and Ramon Alvarez-Valdes and Gerasimos Koulouris and Jose Manuel Tamarit, 2015). This
...
charger, partial charging, and accounting for consumption costs (Whitaker, Justin and Droge, Greg and Hansen, Matthew and Mortensen, Daniel and Gunther, Jacob, 2023). The work in
(Whitaker, Justin and Droge, Greg and Hansen, Matthew and Mortensen, Daniel and Gunther, Jacob, 2023) presents an optimization framework that assumed a fixed schedule, utilized non-linear
battery dynamics, partial charging, considers limited charger availability, consumption cost, and allows for multiple
charger types (Whitaker, Justin and Droge, Greg and Hansen, Matthew and Mortensen, Daniel and Gunther, Jacob, 2023). This paper expands on these previous works by introducing a simulated
...
(Tao Liu and Avishai {(Avi) Ceder}, 2020). Note that charging beyond the 80\% SOC threshold is undesirable due to battery health
concerns as higher SOC with deep cycles accelerates degradation (Edge, Jacqueline S. and O’Kane, Simon and Prosser, Ryan and Kirkaldy, Niall D. and Patel, Anisha N. and Hales, Alastair and Ghosh, Abir and Ai, Weilong and Chen, Jingyi and Yang, Jiang and Li, Shen and Pang, Mei-Chin and Bravo Diaz, Laura and Tomaszewska, Anna and Marzook, M. Waseem and Radhakrishnan, Karthik N. and Wang, Huizhi and Patel, Yatish and Wu, Billy and Offer, Gregory J., 2021, Millner, Alan, 2010).
...
(Gendreau, Michel and Potvin, Jean-Yves, 2018, {William H. Press} and Flannery, Brian P and Teukolsky, Saul A and Vetterling, William T, 1992). A metaheuristic is a high-level problem-independent algorithm
framework that provides a set of guidelines or strategies to develop heuristic optimization algorithms
(Radosavljevic, Jordan, 2018). That is, metaheuristic strategies provides guidelines for implementation;
...
theoretically and in its implementation (Gendreau, Michel and Potvin, Jean-Yves, 2018, Radosavljevic, Jordan, 2018). SA is also of
considerable interest for global optimization over regions containing several local and global minima due to inherent
non-linearities of the objective function (Gendreau, Michel and Potvin, Jean-Yves, 2018). This model is named after its analogized
...
(Darrall Henderson and Sheldon H. Jacobson and Alan W. Johnson, 1989, {William H. Press} and Flannery, Brian P and Teukolsky, Saul A and Vetterling, William T, 1992). SA establishes a connection between this thermodynamic
...
mechanisms (Andre A. Keller, 2019, {William H. Press} and Flannery, Brian P and Teukolsky, Saul A and Vetterling, William T, 1992). The temperature function describes the speed at
...
the previous solution (Gendreau, Michel and Potvin, Jean-Yves, 2018). The acceptance criteria is a function of the system temperature
...
(R.A. Rutenbar, 1989, Darrall Henderson and Sheldon H. Jacobson and Alan W. Johnson, 1989). There are three common basic types of cooling
equations: linear, geometric, and exponential. Geometric cooling schedules are most widely used in practice
(Andre A. Keller, 2019). As such, it will also be employed by this work. It is defined by the difference
equation
...
Generation mechanisms are used to create a neighboring candidate solution (Gendreau, Michel and Potvin, Jean-Yves, 2018). That is,
...
As suggested by the works in (Zhang, Defu and Liu, Yongkai and M’Hallah, Rym and Leung, Stephen C.H., 2010,  Xinchao, Zhao, 2011), applying heuristics to the generating functions can
...
implementation of the PAP derived from (Qarebagh, Ahad Javandoust and Sabahi, Farnaz and Nazarpour, Dariush, 2019). The inputs to the system are the same as those
...
utilizing the Gurobi MILP solver ({Gurobi Optimization, LLC}, 2021).
...
(Nan Qin and Azwirman Gusrialdi and R. {Paul Brooker} and Ali T-Raissi, 2016). The algorithm has been modified slightly to accommodate the case of multiple charger types
...
between the two being about \fpeval{5785.76 - 4797.75} kWh. The peak demands between the heuristic SA, quick
