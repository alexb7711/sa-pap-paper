...
PAP algorithm. \uline{For the case of the pseudo SA algorithm to be presented, the notation will be self-contained and not
...
the temperature schedule \(t_m \in t\). Lines 4 and 5 generates a new solution then calculates its fitness. \(\omega\) in this
context is defined as \(\omega = (u, d, v, \eta)\). Lines 6 through 11 update the solution depending on if the new solution is in
