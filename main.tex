...
selection and returns a random charging time, \([u_i, d_i]\), if it is. The function \texttt{findFreeTime} is defined in
...
and upper bound of the time between scheduled times. The set of cases are shown in \ref{fig:find-free}. In each case depicted
