...
\pgfplotstableread[col sep= comma]{data/qm-charge.csv}\chargedataqin

\begin{tikzpicture}
\pgfplotstablegetcolsof{\chargedataqin}
\pgfmathtruncatemacro\NumCols{\pgfplotsretval/2-1}
\begin{axis}[title={Qin Charges},
      scale only axis,
      ...
      ylabel={Charge [kWh]}]
        \foreach \i in {0, ..., \NumCols}
        {
            ...
            \addplot +[mark=none] table[x index=\u, y index =\etas, unbounded coords=jump]{\chargedataqin};
        }
\end{axis}
\end{tikzpicture}
