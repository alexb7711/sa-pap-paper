...
$dt_h$ is the discrete time slice $dt_h = t_h - t_{h-1}$. \epsilon_q$ is the cost for assigning a charger to queue $q \in Q$.
...
#+begin_comment
TODO: The \phi part of this is going to have to be updated to be a function
#+end_comment
...
[fn:2] This is being changed into a decision variable. This footnote is to keep track of this text.
