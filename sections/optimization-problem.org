...
This is effectively the cost of selecting queue $q_i$. In the [[#sec:sa-example]], a particular choice for the assignment
...
utilizing [[eq:consumption-cost]], $z_c$ may also be used simply as a weight for the consumption cost. Within the summation,
