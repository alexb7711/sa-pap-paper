...
the local search at a constant temperature. In total, that results in $758,500$ configurations being searched.
...
all the queues have been exhausted. For this reason, this heuristic method is dubbed as the exhaustive approach.
