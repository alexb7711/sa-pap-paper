...
\ref{fig:charge} depicts the SOC for each visit throughout the simulation of each framework. [[tab:charge]] tabulates
...
shown in [[tab:charge]]. The Qin model allowed the SOC for one of the BEBs to reach 0% as shown in
