...
PAP are also used as comparisons to the SA PAP technique presented in this work. [[#sec:sa-results]] presents the results for
...
distinguish the heuristic implementation from the method derived in [[#sec:sa-generation-mechanisms]], let this implementation
