...
\pgfplotstableread[col sep = comma]{data/sa-quick-charge-cnt.csv}\usagedatasa
...
\begin{axis}[title={Slow Charge Usage},
    ...
    \addlegendentry{MILP}
    \addplot[green!80!black, fill=green, fill opacity=0.5, no markers] table[x=visit, y=slow] {\usagedatasa};
    \addlegendentry{SA}
\end{axis}
\end{tikzpicture}%\
}
