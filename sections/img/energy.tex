...
\pgfplotstableread[col sep = comma]{data/sa-exhaustive-acc-energy-usage.csv}\accenergydatasaexhaustive
...
\begin{axis}[title={Accumulated Energy Usage},
    ...
    % SA Exhaustive ----------
    \addplot[yellow!100!black, no markers]
             table[x=time, y=power] {\accenergydatasaexhaustive};
