...
The =findFreeTime= algorithm behaves as follows. Lines 1 and 2 of \ref{alg:find-free-time} extract the lower and upper
...
by purging visit $i$. Line 4 sets the new charge time frame, $[u_i, d_i]$. Line 5 the updates visit. If =findFreeTime=
...
$[a_i, e_i]$ for charger $q$. Line 5 sets and returns the updated visit. If =findFreetime= was unsuccessful, then the
