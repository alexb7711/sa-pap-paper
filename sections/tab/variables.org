...
| $J(\cdot)$                      | Objective function                                                                   | $n_K$                       | Number of iterations in the repetition schedule                              |
| $n_M$                       | Total number of steps created by initial temperature, $\Tau_0$, and cooling schedule | $n_Q$                       | Number of chargers                                                           |
| $\T$                        | Time horizon                                                                         | $n_h$                       | Number of discrete steps in time horizon                                     |
| $n_V$                       | Total number of visits                                                               |                             |                                                                              |
|-----------------------------+--------------------------------------------------------------------------------------+-----------------------------+------------------------------------------------------------------------------|
...
| $\eta_i$                       | Charge for the bus upon arrival visit $i$                                            | $s_i$                       | Amount of time spent on charger for visit $i$ (service time)                 |
