...
the solution space. Therefore, the objective function and constraints introduced in [[#sec:sa-constraints]] and
[[#sec:sa-objective-function]], respectively, must be employed to verify that the output of
